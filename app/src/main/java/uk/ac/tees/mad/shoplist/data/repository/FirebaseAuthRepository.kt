...
class FirebaseAuthRepository(private val auth: FirebaseAuth) {
    fun signUp(email: String, pass: String): Flow<FirebaseAuthResult<Boolean>> = flow {
        try {
    ...
    fun signIn(email: String, pass: String): Flow<FirebaseAuthResult<Boolean>> = flow {
        try {
            emit(FirebaseAuthResult.Loading)
    ...
    fun getCurrentUserDetails(): Flow<FirebaseAuthResult<UserDetails>> = flow {
        emit(FirebaseAuthResult.Loading)
        try {
    ...
    fun updateDisplayName(displayName: String): Flow<FirebaseAuthResult<Boolean>> = flow {
        emit(FirebaseAuthResult.Loading)
        try {
